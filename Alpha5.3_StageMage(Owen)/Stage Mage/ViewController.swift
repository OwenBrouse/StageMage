...
//        aniScrollView = UIView.init(frame: CGRect.init(x: 0.0, y: 0.0, width: aniScroll.frame.width, height: aniScroll.frame.height*2))
  //      aniScrollView.backgroundColor = UIColor.red
  //      aniScrollView.leadingAnchor.isEqual(aniScroll.leftAnchor)
    //    aniScrollView.trailingAnchor.isEqual(aniScroll.rightAnchor)
      //  aniScrollView.topAnchor.isEqual(aniScroll.topAnchor)
        //aniScrollView.bottomAnchor.isEqual(aniScroll.bottomAnchor)
//        aniScrollView.heightAnchor.isEqual(aniScroll.heightAnchor)
  //      aniScrollView.widthAnchor.isEqual(aniScroll.widthAnchor)
    //    aniScroll.addSubview(aniScrollView)
...
//ReactionFuntion#############################################################################################################################ReactionFuntion
    ...
    @IBAction func MenuShift(_ sender: Any) {
        if MenuView.isHidden == true{
            ...
            UIView.animate(withDuration: 0.5) {
                ...
                self.MenuButton.frame.origin.y = self.MenuView.frame.height
    ...
    @IBAction func rotatePress(_ sender: Any) {
        ...
        aniHeight.constant = CGFloat((animations.count-1)*90)
        aniScrollView.updateConstraints()
        
        if aniScrollView.subviews.count > 0 {
        ...
        var space  = 4
        for i in 0...animations.count-1{
            space = animations[i].drawClose(list1: items, num: space)
